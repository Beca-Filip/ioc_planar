function plot_joint_traj_from_vars(num_vars)
...
for ii = 1 : n
    ...
    hold on;
    plot(t, num_vars.variables.q(ii, :));
    ...
    hold on;
    plot(t(1:end-1), num_vars.variables.dq(ii, :));
    ...
    hold on;
    plot(t(1:end-2), num_vars.variables.ddq(ii, :));
    ...
    hold on;
    plot(t(1:end-2), num_vars.functions.model_tau(ii, 1:end-2));
