...
hold all;
plot_snapshots_from_vars(num_vars_1, 8);
...
figure('WindowState', 'maximized');
hold all;
plot_snapshots_from_vars(num_vars_2, 8);
plot(goal(1), goal(2), 'ro', 'MarkerFaceColor', 'auto', 'MarkerSize', 20);
axis('equal');
expandAxes(1.2);
grid;
...
figure('WindowState', 'maximized');
hold all;
plot_snapshots_from_vars(num_vars_3, 8);
plot(goal(1), goal(2), 'ro', 'MarkerFaceColor', 'auto', 'MarkerSize', 20);
axis('equal');
expandAxes(1.2);
grid;
...
figure('WindowState', 'maximized');
hold all;
plot_snapshots_from_vars(num_vars_4, 8);
plot(goal(1), goal(2), 'ro', 'MarkerFaceColor', 'auto', 'MarkerSize', 20);
axis('equal');
expandAxes(1.2);
grid;
...
figure('WindowState', 'maximized');
hold all;
plot_snapshots_from_vars(num_vars_5, 8);
plot(goal(1), goal(2), 'ro', 'MarkerFaceColor', 'auto', 'MarkerSize', 20);
axis('equal');
expandAxes(1.2);
grid;
